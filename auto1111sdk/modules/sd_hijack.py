...
from . import devices, shared, script_callbacks, errors, sd_unet, patches
from .hypernetworks import hypernetwork
from .shared import cmd_opts
from . import sd_hijack_clip, sd_hijack_open_clip, sd_hijack_unet, sd_hijack_xlmr, xlmr, xlmr_m18
...
optimizers = []
current_optimizer = None #: sd_hijack_optimizations.SdOptimization = None
...
class StableDiffusionModelHijack:
    ...
    def __init__(self):
        from .  import textual_inversion
        self.extra_generation_params = {}
        self.comments = []

        self.embedding_db = textual_inversion.textual_inversion.EmbeddingDatabase()
    ...
    def hijack(self, m):
        ...
        from .models.diffusion import ddpm_edit

        if isinstance(m, ldm.models.diffusion.ddpm.LatentDiffusion):
            sd_unet.original_forward = ldm_original_forward
        elif isinstance(m, ddpm_edit.LatentDiffusion):
            sd_unet.original_forward = ldm_original_forward
