import torch
from . import prompt_parser, devices, sd_samplers_common

from .shared import opts, state
from . import shared as shared
from .script_callbacks import CFGDenoiserParams, cfg_denoiser_callback
from .script_callbacks import CFGDenoisedParams, cfg_denoised_callback
from .script_callbacks import AfterCFGCallbackParams, cfg_after_cfg_callback
...
class CFGDenoiser(torch.nn.Module):
    ...
    def forward(self, x, sigma, uncond, cond, cond_scale, s_min_uncond, image_cond):#, sd_model):
        ...
        is_edit_model = self.sd_model.cond_stage_key == "edit" and self.image_cfg_scale is not None and self.image_cfg_scale != 1.0
