...
from .. import shared, devices, sd_hijack, sd_models, images, sd_hijack_checkpoint, errors#, sd_samplers
from . import dataset
from .learn_schedule import LearnRateScheduler

from .image_embedding import embedding_to_b64, embedding_from_b64, insert_image_data_embed, extract_image_data_embed, caption_image_overlay
from .logging import save_settings_to_file
...
class EmbeddingDatabase:
    ...
    def get_expected_shape(self, sd_model):
    ...
    def load_textual_inversion_embeddings(self, sd_model, force_reload=False):
        if not force_reload:
            need_reload = False
        ...
        self.expected_shape = self.get_expected_shape(sd_model)
...
def train_embedding(id_task, embedding_name, learn_rate, batch_size, gradient_step, data_root, log_directory, training_width, training_height, varsize, steps, clip_grad_mode, clip_grad_value, shuffle_tags, tag_drop_out, latent_sampling_method, use_weight, create_image_every, save_embedding_every, template_filename, save_image_with_stored_embedding, preview_from_txt2img, preview_prompt, preview_negative_prompt, preview_steps, preview_sampler_name, preview_cfg_scale, preview_seed, preview_width, preview_height):
    ...
    dl = dataset.PersonalizedDataLoader(ds, latent_sampling_method=latent_sampling_method, batch_size=ds.batch_size, pin_memory=pin_memory)
