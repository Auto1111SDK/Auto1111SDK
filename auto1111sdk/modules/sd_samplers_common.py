...
from . import devices, images, sd_vae_approx, sd_vae_taesd, shared
...
def samples_to_images_tensor(sample, approximation=None, model=None):
    ...
    if approximation == 2:
        ...
        x_sample = sd_vae_approx.model(model)(sample.to(devices.device, devices.dtype)).detach()
...
class Sampler:
    def __init__(self, funcname, model, tqdm_val):
        self.tqdm_val = tqdm_val
    ...
    def create_noise_sampler(self, x, sigmas, p):
        ...
        from .k_diffusion.k_diffusion.sampling import BrownianTreeNoiseSampler
